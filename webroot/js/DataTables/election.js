    ...
    var myTable = $('#indexTable').DataTable({
                   ...
                   //  "deferRender": true,
                     "ajax": {
                       ...
                       columns:[
                           {data:null},
                           {data:'village_electoral_id'},
                           {data:'village.village_name'},
                           {data:'reference_year'},
                           {data:'electoral_total_household'},
                           {data:'electoral_total_voter'},
                           {data:null}
                    ],
                    language: {
                            ...
                            "columnDefs": [ 
                                                   ...
                                                   
                                                 {
                                                    ...
                                                    render:function (data, type, row) {
                                                         var id = row.village_electoral_id;
                                               
                                                            return '<a href="village-electorals/edit/'+ id +'">Edit</a>|<a class="delete" id="'+ id +'"  href="#">Delete</a>';
                                                             }
   ...
   myTable.on( 'order.dt search.dt', function () {
    ...
    $('#indexTable tbody').off('click', 'a.delete').on('click', 'a.delete', function(){
       ...
       // console.log(rowid);
        ...
        {
            $.ajax({
                url:"village-electorals/ajaxDelete.json",
               // url:deleteUrl,
                type:"post",
                data:{"id":rowid},
