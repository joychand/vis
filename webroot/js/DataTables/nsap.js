    ...
    var myTable = $('#indexTable').DataTable({
                   ...
                   //  "deferRender": true,
                     "ajax": {
                       ...
                       columns:[
                           {data:null},
                           {data:'village_nsap_id'},
                           {data:'village.village_name'},
                           {data:'total_widows_beneficiary'},
                           {data:'total_handicap_beneficiary'},
                           {data:'total_ignoaps_beneficiary'},
                           {data:null}
                    ],
                    language: {
                                                ...
                                                // },
                                                   
                                                 {
                                                    ...
                                                    render:function (data, type, row) {
                                                         var id = row.village_nsap_id;
                                               
                                                            return '<a href="/village-nsaps/edit/'+ id +'">Edit</a>|<a class="delete" id="'+ id +'"  href="#">Delete</a>';
                                                             }
