            ...
            <tr>
                ...
                <td>
                    <div  id="first-div" class="row ">
                        <?php $modalid= uniqid();?>
                        <?=  $this->Html->image('VillagePhotos/photo/thumbnail-'.$villagePhoto->photo, ['height' => '100px','data-open'=>'photo-'.$modalid]); ?></td>
                        

                         <div class="  small-3 small-centered columns medium reveal" id="photo-<?php echo $modalid;?>" data-reveal>
