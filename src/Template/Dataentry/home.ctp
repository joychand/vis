...
<div  class=" large-9 medium-8 " style="margin: auto !important ;border: 3px !important; padding: 10px!important;">
 ...
 <fieldset>
<?= $this->Form->create() ?>
<?= $this->Form->control('category',['type'=>'select','required'=>true,'label'=>'Department/Schemes:','options'=>['Anganwadi','CAF&PD','Education(Infra)','Election','Health(Infra)','NERCORMP(Demography)','NREGA','NSAP','GTV Report (Demography)','VillageSchemes','Security Report(Demography)','Census(Demography)','HillHouse Tax(Demography)','Connectivity Infra','Power Infra','Village Disable Info'],'empty'=>'Select Dept/Schemes']) ?> 
