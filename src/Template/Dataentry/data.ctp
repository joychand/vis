...
<div  class=" large-6 medium-5 " style="margin: auto !important ;border: 3px !important; padding: 10px!important;">
 ...
 <fieldset>
<?= $this->Form->create() ?>
<?= $this->Form->control('category',['type'=>'select','label'=>'Department/Schemes:','options'=>['Anganwadi','CAF&PD','Education(Infra)','Election','Health(Infra)','NERCORMP(Demography)','NREGA','NSAP','SDO Report (Demography)','Schemes','Security Report(Demography)','Connectivity Infra','Power Infra','Village Disable Info'],'empty'=>'Select Dept/Schemes']) ?> 
