...
<div class="anganwadis form large-9 medium-8 columns content">
    ...
    <fieldset>
       ...
       <?php
            echo $this->Form->control('anganwadi_reference_year',['type'=>'select','label'=>'Ref.Yr','options'=>['2011'=>'2011','2012'=>'2012','2013'=>'2013','2014'=>'2014','2015'=>'2015','2016'=>'2016','2017'=>'2017','2018'=>'2018'],'empty'=>'Select Yr.','required'=>true,'class'=>'ref_yr','value'=>$selected_ref_yr]);
            ...
            echo $this->Form->control('total_enrolled_children',['label'=>'3.Total Enrolled Childres:','required'=>true,'min'=>0]);
